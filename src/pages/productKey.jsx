    ...
    return ( 
        ...
        <form className="h-[90%] w-full" onSubmit={handleSubmit}>
          ...
          <div className="h-[30%] w-[100%] flex justify-center items-center">
            <button className="bg-[#B76C47] h-[50%] w-[80%] rounded-sm text-white xl:text-[20px] 2xl:text-[30px] scale-100 hover:scale-[1.01] hover:bg-[#b1775a]">
            Continue
            </button>
          </div>
        </form>
        <div className="h-[10%] w-full flex justify-center items-start text-[#616161] xl:text-[15px] 2xl:text-[20px]">
          <p className="text-blue-500 pl-1 cursor-pointer">Exit</p>
        </div>
        </div>
        </div>
     );
